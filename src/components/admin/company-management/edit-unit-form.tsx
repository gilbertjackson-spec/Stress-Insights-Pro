...
export function EditUnitForm({ companyId, unit, onFinished }: EditUnitFormProps) {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      await updateUnit(firestore, companyId, unit.id, values.name);
      toast({
        title: 'Unidade Atualizada!',
        description: `A unidade foi atualizada para "${values.name}".`,
      });
      form.reset();
      onFinished();
    } catch (error) {
